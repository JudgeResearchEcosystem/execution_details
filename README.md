...
Let's try to organize our conversations about execution around this (small) repo.  **Please read it before scheduling a call to answer questions about execution.**  
